...
function initInterface(){
    ...
    console.log("postypeRadio.length is "+ postypeRadio.length);
    for (var i = 0; i < postypeRadio.length; i++) {
        postypeRadio[i].addEventListener("click", function (event) {
            ...
            if (this.checked) {
                ...
                console.log("i is "+i);
                console.log("changePos is "+ changePos);
            }
        });
    }

    // var objpos = document.getElementById('objpos');
    // objpos.addEventListener("click", function(event) {
    // 	var value = this.value;
    //     if (this.checked) {
    //     	changePos = parseInt(value);
    //         restoreSliderValue(changePos);
    //         console.log("objpos is checked");
    //         console.log("changePos is "+ changePos);
    //     }
    // });
